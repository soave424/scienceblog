...
import {
  analyzeFactOpinion,
  AiFactOpinionAnalyzerOutput,
} from "@/ai/flows/ai-fact-opinion-analyzer";
import Image from "next/image";
import { PlaceHolderImages } from "@/lib/placeholder-images";

export default function PracticePage() {
  const [inputText, setInputText] = useState("");
  const [analysis, setAnalysis] = useState<AiFactOpinionAnalyzerOutput | null>(
    null,
  );
      ...
      <main className="container mx-auto py-10 px-4 max-w-5xl">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground text-lg">
            과학적 관찰은 주관적인 '느낌'이 아닌 객관적인 '사실'을 기록하는
            것에서 시작합니다.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <Card className="border-none shadow-xl overflow-hidden">
            ...
            <CardHeader className="p-6">
              ...
              <CardDescription>
                보이는 그대로를 숫지, 모양, 색깔 등을 사용하여 설명해보세요.
              </CardDescription>
            </CardHeader>
